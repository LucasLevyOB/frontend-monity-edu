...
const DashboardAluno = () => {
  ...
  const fetchNextMonitorias = async (searchText, page = nextMonitorias.page + 1) => {
  ...
  const fetchPastMonitorias = async (searchText, page = pastMonitorias.page + 1) => {
    const api = new ApiService();
  ...
  const debouncedFetch = debounce(() => {
    ...
    fetchNextMonitorias(searcText, 1);
    setNextMonitorias({ data: [], page: 0, totalPages: 1, totalItems: 0 });
    fetchPastMonitorias(searcText, 1);
  }, 1000);
